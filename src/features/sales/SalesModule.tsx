...
export function SalesModule({ userRole }: SalesModuleProps) {
  ...
  const [employees] = useState<Employee[]>([
    ...
    },
    {
      ...
      position: "Especialista Facial"
    },
    {
      id: 3,
      name: "María Elena Torres",
      document: "52345678",
      email: "maria.torres@highlifespa.com",
  ...
  const [appointments] = useState<Appointment[]>([
    {
      ...
      service: "Masaje Sueco Premium",
      employee: "Ana María García",
  ...
  const [sales, setSales] = useState<Sale[]>([
    {
      ...
      date: "2025-10-16",
      items: [
        { serviceId: 1, serviceName: "Masaje Sueco Premium", price: 120, quantity: 1 }
      ],
      subtotal: 120,
      discount: 0,
      total: 120,
    ...
    },
    {
      ...
      date: "2025-10-15",
      items: [
        { serviceId: 2, serviceName: "Tratamiento Facial", price: 95, quantity: 1 },
        { serviceId: 5, serviceName: "Spa Bar Experience", price: 25, quantity: 1 }
      ],
      subtotal: 120,
      discount: 10,
      total: 110,
    ...
    },
    {
      ...
      date: "2025-10-14",
      items: [
        { serviceId: 3, serviceName: "Aromaterapia", price: 110, quantity: 1 }
      ],
      subtotal: 110,
      discount: 0,
      total: 110,
    ...
    },
    {
      ...
      date: "2025-10-13",
      items: [
        { serviceId: 4, serviceName: "Manicure & Pedicure", price: 75, quantity: 1 }
      ],
      subtotal: 75,
      discount: 0,
      total: 75,
